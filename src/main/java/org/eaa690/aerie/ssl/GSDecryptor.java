...
public class GSDecryptor {
     ...
     */
    public String decrypt(final String encryptedDataStr) {
        try {
            ...
            return new String(comparisonBytes);
        } catch (InvalidCipherTextException e) {
            log.error("Unable to decrypt.  Input={}; Error={}", encryptedDataStr, e.getMessage());
        }
        return null;
    }
}
