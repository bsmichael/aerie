...
# forward(speed, duration): Sets both motors to move forward for duration seconds at speed. 0 <= speed <= 100
# reverse(speed, duration): Sets both motors to reverse for duration seconds at speed. 0 <= speed <= 100
# spinLeft(speed, duration): Sets motors to turn opposite directions for duration seconds at speed. 0 <= speed <= 100
# spinRight(speed, duration): Sets motors to turn opposite directions for duration seconds at speed. 0 <= speed <= 100
...
# forward(speed): Sets both motors to move forward for duration seconds at speed. 0 <= speed <= 100
